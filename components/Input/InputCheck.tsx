...
const InputCheck = forwardRef(function InputCheck(props: InputCheckProps, ref) {
    const { title, value = false } = props
    ...
    return (
        <div className="">
            <div className="flex flex-row gap-5 justify-between items-center">
                <div className="block text-md font-medium text-white">{title}</div>
                <input
